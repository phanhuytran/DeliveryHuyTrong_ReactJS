    ...
    render() {
        ...
        return (
            <div>
                        ...
                        <div className="row">
                            <div className="col-md-6 col-sm-6">
                                <div className="about_us_content">
                                    ...
                                    <a id="show-read-more" onClick={show_about_content}>see more <span className="fas fa-arrow-down" /></a>
                                    <a id="hide-away" onClick={hide_about_content}>see less <span className="fas fa-arrow-up" /></a>
                                </div>
                            </div>
                ...
                <section className="about-us-bottom-area">
                    <div className="container">
                        <div className="row">
                            <h2>Delivery Huy Trong</h2><br />
                            <div className="col-md-4 col-sm-4 col-xs-12 col-lg-4">
                                <div className="single-about-us-bottom">
                                    <h4>what we do</h4>
